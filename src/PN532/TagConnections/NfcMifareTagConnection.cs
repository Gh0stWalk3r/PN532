namespace PN532.TagConnections
{
    ...
    public class NfcMifareTagConnection : NfcTagConnection
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="NfcMifareTagConnection"/> class.</summary>
        ...
        {
            byte[] dataOut = new byte[8 + this.Id.Length]; // 8 -> fixed part (key type, block number, key bytes value)
